...
#Initialize logger
logging.basicConfig(filename='representation_test_log.log', level=logging.INFO, 
...
def read_csv_file_test(file_path):
    correct_column_names = ['PDB_code', 'resolution', 'release_year', '-logKd/Ki', 'Kd/Ki', 'target']
    try:
